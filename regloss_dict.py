...
def main():
    ...
    if args.source_pair:
        ...
        conn = get_db(args.db)
        source_entries = get_entries(conn, source_target, source_home_code)
        ...
        results = run_regloss(
            ...
            client, args.model, args.batch_size, system_prompt,
        )
